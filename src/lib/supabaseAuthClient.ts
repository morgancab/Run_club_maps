...
// de sécurité en soi. Le vrai contrôle d'accès se fait côté serveur :
// lib/adminAuth (ADMIN_EMAIL) pour /admin, lib/ownerAuth + owner_email pour
// /mon-club. Partagé par les deux bundles (voir src/admin/, src/owner/).
